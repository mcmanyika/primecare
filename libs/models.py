...
class Client(models.Model):
    Daily_Login_ID = models.CharField(max_length=20, default='', null=True, blank=True)
    Daily_Logout_ID = models.CharField(max_length=20, default='', null=True, blank=True)
...
class t_sub_url(models.Model):
    ...
    slug = models.SlugField(max_length=100, default='', unique=True , db_index=True)
    toggle = models.CharField(max_length=20, default='modal')
    page_type = models.CharField(max_length=20, default='', null=True, blank=True)
    status = models.CharField(max_length=20, default='', null=True, blank=True)
    user = models.IntegerField(null=True, blank=True)
    timestamp = models.DateTimeField(auto_now_add = True, auto_now=False)
    updated = models.DateTimeField(auto_now_add = False, auto_now=True)
